...
class ControllerMarketplaceModification extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			foreach ($this->request->post['selected'] as $modification_id) {
				$this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->deleteModification($modification_id);
			}
	...
	public function refresh($data = array()) {
		...
		if ($this->validate()) {
			...
			$results = $this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->getModifications();
                }
...
$url = $this->getListUrlParams();
	...
	public function enable() {
		...
		if (isset($this->request->get['modification_id']) && $this->validate()) {
			$this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->enableModification($this->request->get['modification_id']);
	...
	public function disable() {
		...
		if (isset($this->request->get['modification_id']) && $this->validate()) {
			$this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->disableModification($this->request->get['modification_id']);
	...
	protected function getList() {
		if (isset($this->request->get['sort'])) {
			...
			$sort = (file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php')) ? 'date_modified' : 'name';
		}

		if (isset($this->request->get['order'])) {
			$order = $this->request->get['order'];
		} else {
			$order = (file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php')) ? 'DESC' : 'ASC';
		}
		...
		if (file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php')) {
			...
			$modification_total = $this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->getTotalModifications();
		}

		$results = $this->{file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'model_extension_module_modification_manager' : 'model_setting_modification'}->getModifications($filter_data);
		...
		$this->response->setOutput($this->load->view(file_exists(DIR_APPLICATION . 'model/extension/module/modification_manager.php') ? 'extension/module/modification_manager/list' : 'marketplace/modification', $data));
	}
