...
$_['text_success'] = 'Успех: вы изменили данные учетной записи SagePay!';
$_['text_edit'] = 'Изменить сервер SagePay';
$_['text_test'] = 'Тест';
$_['text_live'] = 'Жить';
...
$_['help_transaction'] = 'Для метода транзакции ДОЛЖЕН быть установлен «Платеж», чтобы разрешить оплату подписки.';
...
// Error
$_['error_permission'] = 'Внимание: у вас нет разрешения на изменение платежа SagePay!';
