<?php
// Heading
$_['heading_title'] = 'Редирект Реалекс';

// Text
$_['text_extension'] = 'Расширения';
$_['text_success'] = 'Успех: вы изменили данные учетной записи Realex!';
$_['text_edit'] = 'Изменить перенаправление Realex';
$_['text_live'] = 'Жить';
$_['text_demo'] = 'Демо';
...
$_['text_url_message'] = 'Прежде чем начать работу, вы должны предоставить URL-адрес магазина своему менеджеру по работе с клиентами Realex.';
...
$_['text_realex'] = '<a target="_blank" href="http://www.realexpays.co.uk/partner-refer?id=opencart"><img src="view/image/paying/realex.png" alt="Realex" title="Realex" style="border: 1px сплошной #EEEEEE;" /></а>';
$_['text_void'] = 'Пустота';
...
$_['help_notification'] = 'Вам необходимо предоставить этот URL-адрес Realex, чтобы получать уведомления о платежах.';
...
$_['help_dcc_settle'] = 'Если ваш субсчет поддерживает DCC, вы должны использовать Autosettle.';
...
$_['error_use_select_card'] = 'Для работы маршрутизации субсчета по типу карты у вас должна быть включена опция «Выбор карты».';