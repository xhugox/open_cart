<?php
// Heading
$_['heading_title'] = 'Глобалпэй удаленно';

// Text
$_['text_extension'] = 'Расширения';
$_['text_success'] = 'Успех: вы изменили данные учетной записи Globalpay!';
...
$_['text_ip_message'] = 'Прежде чем начать работу, вы должны сообщить IP-адрес своего сервера своему менеджеру по работе с клиентами Globalpay.';
...
$_['text_globalpay_remote'] = '<a target="_blank" href="https://resourcecentre.globaliris.com/getting-started.php?id=OpenCart"><img src="view/image/paid/globalpay.png" alt="Globalpay" title="Globalpay" style="border: 1px сплошной #EEEEEE;" /></а>';
$_['text_void'] = 'Пустота';
...
$_['entry_rebate_password'] = 'Пароль для скидки';
$_['entry_total'] = 'Общий';
...
$_['entry_liability_shift'] = 'Примите сценарии переноса ответственности';
...
$_['entry_status_decline_pending'] = 'Отклонение – офлайн-аутентификация';
$_['entry_status_decline_stolen'] = 'Отказ – карта утеряна или украдена';
$_['entry_status_decline_bank'] = 'Отклонение – ошибка банка';
$_['entry_status_void'] = 'аннулирован';
$_['entry_status_rebate'] = 'с фальцем';
...
$_['help_notification'] = 'Вам необходимо предоставить этот URL-адрес в Globalpay, чтобы получать уведомления о платежах.';
...
$_['help_liability'] = 'Принятие ответственности означает, что вы по-прежнему будете принимать платежи, даже если пользователь не использует 3D Secure.';
$_['help_card_data_status'] = 'Регистрирует последние 4 цифры карты, срок действия, имя, тип и информацию о банке-эмитенте.';
