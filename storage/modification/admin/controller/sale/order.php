...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
            ...
            // Klix Payment Integration for Admin
            $data['spell_order_total'] = $order_info['total'];
            
            if (strpos($order_info['payment_code'], 'spell_payment') !== false) {
                $payment_id = str_replace(array("spell_payment", "spell_payment_"), "", $order_info['payment_code']);
            } else {
                $payment_id = '';
            }
            ...
            $data['payment_code'] = $order_info['payment_code'];
            $data['spell_refund_url'] = $this->url->link('extension/payment/spell_payment/refund', 'user_token=' . $this->session->data['user_token'], true);
			...
			$data['footer'] = $this->load->controller('common/footer');
              ...
              $this->load->library('unisend_shipping/services/UnisendShippingOCMODService');
              $this->UnisendShippingOCMODService::order($data, $this);
