	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_option'])) {
			...
			$product_options = array();
				...
				$data['advancedoption_model'] = $this->config->get('module_advancedoption_model');
				$data['advancedoption_sku'] = $this->config->get('module_advancedoption_sku');
				$data['advancedoption_upc'] = $this->config->get('module_advancedoption_upc');
				$data['advancedoption_ean'] = $this->config->get('module_advancedoption_ean');
				$data['advancedoption_jan'] = $this->config->get('module_advancedoption_jan');
				$data['advancedoption_customer_group'] = $this->config->get('module_advancedoption_customer_group');
				$data['advancedoption_default_status'] = $this->config->get('module_advancedoption_default_status');
				$data['advancedoption_image'] = $this->config->get('module_advancedoption_image');
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				...
				'thumb'           		  => $thumb,
				'customer_group_id'       => (!empty($product_option_value['customer_group_ids']) ? json_decode($product_option_value['customer_group_ids']) : array()),
