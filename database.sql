-- Adminer 4.8.1 MySQL 11.4.9-MariaDB-ubu2204 dump
...
DROP TABLE IF EXISTS `oc_mpsociallogin`;
CREATE TABLE `oc_mpsociallogin` (
...
DROP TABLE IF EXISTS `oc_omniva_m_courier_call`;
CREATE TABLE `oc_omniva_m_courier_call` (
...
DROP TABLE IF EXISTS `oc_omniva_m_label_history`;
CREATE TABLE `oc_omniva_m_label_history` (
...
DROP TABLE IF EXISTS `oc_omniva_m_order_data`;
CREATE TABLE `oc_omniva_m_order_data` (
...
DROP TABLE IF EXISTS `oc_omniva_m_price`;
CREATE TABLE `oc_omniva_m_price` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `country_code` varchar(2) DEFAULT NULL,
  `price_data` text DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `oc_paypal_checkout_integration_order_recurring`;
CREATE TABLE `oc_paypal_checkout_integration_order_recurring` (
  `paypal_order_recurring_id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
  `order_recurring_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
  `date_modified` datetime NOT NULL,
  ...
  PRIMARY KEY (`paypal_order_recurring_id`),
  KEY `order_id` (`order_id`),
...
CREATE TABLE `oc_product_option` (
  ...
  `value` text NOT NULL,
  `required` tinyint(1) NOT NULL,
  `master_option` int(11) NOT NULL DEFAULT 0,
  `master_option_value` int(11) NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS `oc_product_option_value_data`;
...
DROP TABLE IF EXISTS `oc_unisend_shipping`;
CREATE TABLE `oc_unisend_shipping` (
  `unisend_id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `oc_unisend_shipping_method`;
CREATE TABLE `oc_unisend_shipping_method` (
  `unisend_shipping_method_id` int(11) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  ...
  PRIMARY KEY (`unisend_shipping_method_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;


DROP TABLE IF EXISTS `oc_unisend_shipping_method_countries`;
CREATE TABLE `oc_unisend_shipping_method_countries` (
  `unisend_shipping_method_country_id` int(11) NOT NULL AUTO_INCREMENT,
  `code` text NOT NULL,
  `name` text NOT NULL,
  `unisend_shipping_method_id` int(11) NOT NULL,
  PRIMARY KEY (`unisend_shipping_method_country_id`),
  KEY `unisend_shipping_method_id` (`unisend_shipping_method_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;


DROP TABLE IF EXISTS `oc_unisend_shipping_method_sizes`;
CREATE TABLE `oc_unisend_shipping_method_sizes` (
  `unisend_shipping_method_size_id` int(11) NOT NULL AUTO_INCREMENT,
  `size` text NOT NULL,
  `price` decimal(10,2) NOT NULL,
  `unisend_shipping_method_id` int(11) NOT NULL,
  PRIMARY KEY (`unisend_shipping_method_size_id`),
  KEY `unisend_shipping_method_id` (`unisend_shipping_method_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;


DROP TABLE IF EXISTS `oc_unisend_shipping_method_weights`;
CREATE TABLE `oc_unisend_shipping_method_weights` (
  `unisend_shipping_method_weight_id` int(11) NOT NULL AUTO_INCREMENT,
  `weight_from` int(11) NOT NULL,
  `weight_to` int(11) NOT NULL,
  `price` decimal(10,2) NOT NULL,
  `unisend_shipping_method_id` int(11) NOT NULL,
  PRIMARY KEY (`unisend_shipping_method_weight_id`),
  KEY `unisend_shipping_method_id` (`unisend_shipping_method_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;


DROP TABLE IF EXISTS `oc_unisend_shipping_order`;
CREATE TABLE `oc_unisend_shipping_order` (
  ...
  `cod_selected` bit(1) DEFAULT b'0',
  `created` datetime(6) DEFAULT NULL,
  `updated` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`order_id`),
  KEY `IDX_unisend_shipping_order_created` (`created`),
  KEY `IDX1eeooi5whyuq4n07dwdfdht85` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;


DROP TABLE IF EXISTS `oc_unisend_shipping_request`;
CREATE TABLE `oc_unisend_shipping_request` (
...
DROP TABLE IF EXISTS `oc_xdstickers`;
...
DROP TABLE IF EXISTS `oc_xdstickers_product`;
